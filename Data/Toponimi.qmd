...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link url="Server=gisserver_skala_250K; Service=sde:sqlserver:gisserver\skala_250K; Database=Indonesia_250K; Version=dbo.DEFAULT" format="" type="ArcSDE Connection" mimeType="" name="SDE Feature Class" description="" size=""/>
  </links>
  <dates/>
  <fees></fees>
